$(document).ready(function () {
    ...
    AWS.load_list_view(G_BASE_URL + '/people/ajax/income_log/', $('#bp_user_income_more'), $('#bp_user_income'));	// 收益

    AWS.load_list_view(G_BASE_URL + '/people/ajax/income_commission/', $('#bp_user_income_commission_more'), $('#bp_user_income_commission'));	// 提成

    AWS.load_list_view(G_BASE_URL + '/people/ajax/income_register/', $('#bp_user_income_register_more'), $('#bp_user_income_register'));	// 注册奖励

    AWS.load_list_view(G_BASE_URL + '/people/ajax/income_sum/', $('#bp_user_income_sum_more'), $('#bp_user_income_sum'));	// 奖励概述

    AWS.load_list_view(G_BASE_URL + '/people/ajax/income_invite/', $('#bp_user_income_invite_more'), $('#bp_user_income_invite'));	// 邀请奖励
