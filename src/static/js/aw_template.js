var AW_TEMPLATE = {
	...
	'editCommentBox' :
				'<div class="modal fade alert-box aw-edit-comment-box aw-editor-box" data-backdrop="static" data-keyboard="false">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true" style="opacity: 1"></a>'+
						...
						'<div class="modal-body">'+
							...
							'<script id="editor_reply" type="text/plain"  name="answer_content"></script></p>'+
	...
	'editTopicBox' :
		'<div class="aw-edit-topic-box form-inline">'+
			'<input type="text" class="form-control" id="aw_edit_topic_title" autocomplete="off" onkeypress="keypress()" placeholder="' + _t('创建或搜索添加新话题') + '...">'+
