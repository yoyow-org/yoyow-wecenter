...
class main extends AWS_CONTROLLER
{
    ...
    public function index_action()
    {
        ...
        $question_base_url = base_url().'/?/question/question_share/question_id-'.$_GET['id'];
        ...
        if ($_GET['column'] != 'log')
        {
            ...
            else
            {
                ...
                $answer_list = $this->model('answer')->get_answer_list_by_question_id($question_info['question_id'], calc_page_limit($_GET['page'], 20), $answer_list_where, $answer_order_by);
            }
            ...
            foreach ($answer_list as $answer)
            {
                $answer['qr_url'] = $question_base_url.'__answer_id-'.$answer['answer_id'];
                if ($answer['has_attach'])
                {
            ...
            TPL::assign('project_url', base_url());
    ...
    public function markdown_action(){
         TPL::output('block/markdown.tpl.htm');
    }
    ...
    public function question_share_action()
    {
        ...
        if (is_mobile())
        {
            HTTP::redirect('/m/question_share/question_id-' . $_GET['question_id'].'__answer_id-'.$_GET['answer_id']);
        }
    ...
    public function qrcode_action(){
        $url = $_GET['url'];
        return $this->model('weixin')->generate_qrcode($url);
    }
}
