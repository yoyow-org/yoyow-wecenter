...
class help_class extends AWS_MODEL
{
    ...
    public function query_announce_by_id($id){
        $where="id='".$id."'";
        return $this->fetch_row("site_announce",$where,null);
    }

    public function query_link_by_id($id){
        $where="id='".$id."'";
        return $this->fetch_row("site_link",$where,null);
    }

    public function query_site_announce($limit = 10){
        return $this->fetch_all('site_announce','status = 0','time DESC',$limit);
    }

    public function query_index_activity_by_id($id){
        $where="id='".$id."'";
        return $this->fetch_row("index_activity",$where,null);
    }
}
